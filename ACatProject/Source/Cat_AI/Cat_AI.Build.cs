...
public class Cat_AI : ModuleRules

{
    public Cat_AI(ReadOnlyTargetRules Target) : base(Target)
    {
        PCHUsage = PCHUsageMode.UseExplicitOrSharedPCHs;
        PrivatePCHHeaderFile = "Private/Cat_AIPCH.h";
        ...
        PublicIncludePaths.AddRange(new string[] { "Cat_AI/Public" });

        //The path for the source files
        PrivateIncludePaths.AddRange(new string[] { "Cat_AI/Private" });
    }
}
